...
def make_gauge(prob, threshold=THRESHOLD):
    ...
    """
    MAX_DISP = 0.15   # cap display at 15% -- red zone beyond removed
    W, H = 340, 195
    ...
    # Three zones -- red trailing zone removed, capped at 15%
    zones = [
        (0,           THRESHOLD,   "#1a4731", "#22c55e"),   # green
        (THRESHOLD,   ZONE2_UPPER, "#3b2700", "#f59e0b"),   # amber
        (ZONE2_UPPER, MAX_DISP,    "#3b1a00", "#f97316"),   # orange -- extends to cap
    ]
    ...
    ticks = [(0, "0%"), (0.03, "3%"), (0.06, "6%"),
             (0.09, "9%"), (0.12, "12%"), (0.15, "15%")]
    ...
    for z0, z1, fill_bg, fill_arc in zones:
        ...
        # Outer arc stroke in matching zone color
